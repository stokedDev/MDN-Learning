...
To solve these problems we use Asynchronous JS instead. So while some lines are taking a while to run, lines later in the code can run at the same time. Instead of using callbacks(a function passed as an argument to another function or method), the promise is the foundation of asynchronous programming in JS, which I'll learn about in the next article.
*/